...
const host_remote = "https://guitarinventorymanagement-mattpan09.onrender.com";
...
async function updateTheNavigationBar() {
    ...
    let loginTag = document.getElementById("loginPage");
    if (configuration.isLoggedIn()) {
        loginTag.innerHTML = 
        '<li id="loginPage"><a href="#" onclick="logout()">Logout</a></li>';
    }
    else {
        loginTag.innerHTML = '<li id="loginPage"><a href="login.html">Login</a></li>'
    }
}
